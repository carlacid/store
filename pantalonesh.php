	...
	<div class="container-fluid">
		...
		<div class="col-lg-3 lista">
			...
			<div class="menu mb-4">
				<li><input type="checkbox" name="list" id="nivel1-1"><label for="nivel1-1" class="text-dark">Camisas | Polos</label>
					<div class="interior">
						<a href="camisasypolos.php" class="text-dark"><b>Ver todo</b></a><br>
		...
		<div class="col-lg-9">
			<div class="row mt-3">
				...
				$sql = "select DISTINCT Referencia,Foto,Precio,Nombre,Rebaja from ropahombre where Tipo='Pantalon';";
