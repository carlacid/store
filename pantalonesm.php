		...
		<div class="col-lg-3 lista">
			...
			<div class="menu mb-4">
				<li><input type="checkbox" name="list" id="nivel1-1"><label for="nivel1-1" class="text-dark">Camisas | Blusas</label>
					<div class="interior">
						<a href="camisasyblusasm.html" class="text-dark"><b>Ver todo</b></a><br>
						<a href="camisasm.html" class="text-dark">Camisas</a><br>
						<a href="blusasm.html" class="text-dark">Blusas</a>
					</div>
				</li>
			</div>
		...
		<div class="col-lg-9">
			...
			<?php 
				...
				while ($i<$resultado->num_rows){
					...
					echo"<form action='ropa2.php' method='post'>";
	 					echo"<input type='hidden' name='referencia' value='".$Referencia."' />";
	 					//echo"<input type='submit' value=''><img src='img".$Foto.$Referencia.".jpg' class='img-fluid'></input>";
	 					echo"<input title='boton enviar' alt='boton enviar' src='img".$Foto.$Referencia.".jpg' type='image' class='img-fluid' />";
					echo"</form>";
					//echo"<a href='ropa2.php/?variable1=".$Referencia."'><img src='img".$Foto.$Referencia.".jpg' class='img-fluid'></a>";
			...
			/*-------------------------------------------
				<div class="col-lg-3">
					<a href="pantalon1.html" title=""><img src="img/mujer/pantalones/pantalon5.jpg" class="img-fluid"></a>
					<small>Vestido corto</small><br>
					<small><strike>29,95€</strike></small>
					<small class="text-danger">23,96€</small>
				</div>
				<div class="col-lg-3">
					<a href="#" title=""><img src="img/mujer/pantalones/pantalon4.jpg" class="img-fluid"></a>
					<small>Vestido</small><br>
					<small><strike>19,95€</strike></small>
					<small class="text-danger">15,95€</small>
				</div>
				<div class="col-lg-3">
					<a href="#" title=""><img src="img/mujer/pantalones/pantalon1b.jpg" class="img-fluid"></a>
					<small>Vestido</small><br>
					<small><strike>25,95€</strike></small>
					<small class="text-danger">20,95€</small>
				</div>
				<div class="col-lg-3">
					<a href="#" title=""><img src="img/mujer/pantalones/pantalon3.jpg" class="img-fluid"></a>
			...
			<div class="row mt-3">
				<div class="col-lg-3">
					<a href="#" title=""><img src="img/mujer/pantalones/pantalon2.jpg" class="img-fluid"></a>
